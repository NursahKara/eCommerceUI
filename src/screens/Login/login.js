    ...
    render() {
        return (
            <SafeAreaView style={styles.container}>
                ...
                >
                    <Text style={styles.haveAccount}>Forgot your password?</Text>
                </TouchableOpacity>
                <TouchableOpacity style={{ backgroundColor: '#FF8C00', justifyContent: 'center', alignItems: 'center', height: 40, marginHorizontal: 15, marginTop: 40 }}><Text style={{ color: 'white' }}>LOGIN</Text></TouchableOpacity>
